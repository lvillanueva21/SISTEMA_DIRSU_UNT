...
// Obtener la variable de sesión $id_departamento
$id_departamento = $_SESSION['id_depa'];

// Filtro para el departamento: se usará $id_departamento
...
// Se filtran los proyectos por departamento y se muestran solo aquellos cuyo dato usuario tenga una longitud menor a 5.
$query = "SELECT p.*, u.nombres, u.apellidos 
          FROM proyectos p
          INNER JOIN usuarios u ON u.id_py = p.id
          WHERE p.departamento_academico = ?
