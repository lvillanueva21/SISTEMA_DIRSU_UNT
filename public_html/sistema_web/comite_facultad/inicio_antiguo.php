...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Card 02: Solo imagen sin header -->
            <div class="col-md-6">
                <div class="card p-0" style="border: none;">
                    <img src="../imagenes/flyer_capacitacion.webp" alt="Flyer Capacitacion" style="width: 100%; height: auto; display: block;">
                </div>
            </div>

            <!-- Card 03: Cronograma de proyectos DIRSU -->
            <div class="col-md-6">
                <div class="card">
