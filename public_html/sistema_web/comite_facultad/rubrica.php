...
<head>
    ...
    <title>EvaluaciÃ³n por RÃºbrica</title>
    <!-- Favicon -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <?php
  $oficina_actual  = 'pcf';      // NO cambia (sigue siendo PCF)
  $tipo_evaluacion = 'rubrica';  // <â”€â”€ cambia de â€˜cotejoâ€™ a â€˜rubricaâ€™
  include("calificacion/proyectos_rubrica.php");
?>
</section>
        </div>
