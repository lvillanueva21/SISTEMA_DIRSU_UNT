                ...
                <div class="card">
                    <div class="card bg-light d-flex flex-fill">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-12">
                                    <p class="text-muted text-sm text-justify">Como Decano de la Facultad de <b><?php echo isset($facultades[$id_escuela]) ? $facultades[$id_escuela] : 'Facultad no encontrada'; ?></b> serás el encargado de dar el visto bueno a los <b>Informes Semestrales</b> presentados por los coordinadores de proyectos de tu facultad. <br>
                                    <br>
                                        <b>¿Cómo dar el visto bueno?</b> <br>
                                        Dirígete a la opción Evaluación de Proyectos --> Visto bueno. Podrás ver a detalle la información de los proyectos que están solicitando revisión y otorgar el visto bueno del Decanato de Facultad.
                                        <br>
