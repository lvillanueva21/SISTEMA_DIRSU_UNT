...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="inicio.php" class="brand-link">
      <img src="dust/img/dirsu_logo_128_128.png" class="brand-image img-circle elevation-3" style="opacity:.8" alt="AdminLTE Logo">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item"><a href="inicio.php" class="nav-link active"><i class="nav-icon fas fa-home"></i><p>INICIO</p></a></li>
          ...
          <li class="nav-item menu">
            <a href="#" class="nav-link"><span class="badge nav-icon">3</span><p>Evaluación e informe</p></a>
            <ul class="nav nav-treeview">
              <li class="nav-item"><a href="semestral/index.php" class="nav-link"><p>3.1. Informe semestral</p></a></li>
