<?php
/* social.php — Vista “Red Social” (demo con catálogo de imágenes)
...
/* ============================================================
   CATÁLOGO CENTRAL DE IMÁGENES — EDITA AQUÍ TUS URLs
   - Clave => URL pública directa a la imagen (JPEG/PNG/WebP).
   - Debajo de cada clave hay una guía de qué buscar.
   - Si dejas una URL vacía, usaremos un fallback de Unsplash.
   ============================================================ */
$IMG = [
  ...
  'salud_tamizaje'          => 'https://muniporvenir.gob.pe/wp-content/uploads/2021/04/CAMPANA-DE-PREVENCION-19-04-2021-1140x641.jpg',        // Toma de presión/glucosa en campaña
  ...
  'lectura_infantil'        => 'https://imagenes.elpais.com/resizer/v2/5ZPQNY4ROI52YCYFUCZLOHKD7I.jpg?auth=afd6552157db8fa528452042ccb60b5dc3a9f3c3872788dfa55dca3c10a092cb&width=414',      // Niños leyendo en aula
  ...
  // Alfabetización digital (INF-020-2025)
  'capacitacion_computo'    => 'https://source.unsplash.com/1200x675/?computer,training',     // Adultos en sala de cómputo
  'alfabetizacion_tic'      => 'https://source.unsplash.com/1200x675/?digital,literacy',      // Taller TIC para adultos

  // Campaña de abrigo (SOC-044-2025)
  ...
  // Áreas verdes (AMB-029-2025)
  'parque_mantenimiento'    => 'https://source.unsplash.com/1200x675/?urban,park',            // Vecinos arreglando parque
  'siembra_plantones'       => 'https://source.unsplash.com/1200x675/?tree,planting',         // Siembra de árboles
  ...
  'recordatorio_megafono'   => 'https://source.unsplash.com/1200x675/?reminder,megaphone',    // Megáfono/recordatorio
  ...
  'ninos_orquesta'          => 'https://source.unsplash.com/1200x675/?kids,orchestra',        // Niños tocando instrumentos
  'musica_comunidad'        => 'https://source.unsplash.com/1200x675/?music,community',       // Ensayo/presentación comunitaria
...
/* Fallback: si una clave no tiene URL válida, usa una de Unsplash por tema */
...
$posts = [
  [
    ...
    'autor'=>'Dirección RSU','rol'=>'Comunicado',
    'avatar'=>'https://ui-avatars.com/api/?name=RSU&background=0d6efd&color=fff&size=64',
    'titulo'=>'Cierre de presentación de proyectos',
    'codigo'=>null,
    'contenido'=>'📢 Recordatorio: cierre de presentación de proyectos el 25/04/2026. Verifica requisitos y cronograma antes de enviar.',
  ...
  [
    ...
    'titulo'=>'Cultivando huertos escolares – Progreso ENF-014-2025',
    'codigo'=>'ENF-014-2025',
    'contenido'=>'Instalamos 6 bancales y capacitamos a 40 estudiantes en técnicas básicas de riego y compost.',
    'imagenes'=>[ img('huertos_escolares_bancales','school,garden'), img('huertos_capacitacion','gardening,community') ],
    'tags'=>['#educación','#ambiente','#comunidad'],
  ...
  [
    ...
    'titulo'=>'Campaña de salud preventiva – Barrio Los Laureles',
    'codigo'=>'MED-032-2025',
    'contenido'=>'Tamizaje de presión arterial y glucosa a 120 vecinos, derivaciones coordinadas con el centro de salud.',
  ...
  [
    ...
    'titulo'=>'Taller de lectura inicial – I.E. Santa Rosa',
    'codigo'=>'EDU-011-2025',
    'contenido'=>'Se trabajó conciencia fonológica con 2º grado. 5 docentes replicarán la metodología en sus aulas.',
  ...
  [
    ...
    'titulo'=>'Jornada de limpieza de playa – Huanchaco',
    'codigo'=>'AMB-027-2025',
    'contenido'=>'Recolectamos 450 kg de residuos con voluntarios y pescadores. Se entregó reporte a la municipalidad.',
  ...
  [
    ...
    'autor'=>'María L. Campos','rol'=>'Coordinadora',
    'avatar'=>'https://i.pravatar.cc/64?img=47',
    'titulo'=>'Alfabetización digital para adultos – Centro Poblado El Milagro',
    'codigo'=>'INF-020-2025',
    'contenido'=>'20 participantes crearon su correo y aprendieron videollamadas. Próximo módulo: seguridad digital.',
    'imagenes'=>[ img('capacitacion_computo','computer,training'), img('alfabetizacion_tic','digital,literacy') ],
    'tags'=>['#educación','#tecnología','#comunidad'],
  ...
  [
    ...
    'titulo'=>'Campaña de abrigo – Barrio Manco Cápac',
    'codigo'=>'SOC-044-2025',
    'contenido'=>'Se entregaron 180 kits de abrigo y se levantó padrón para seguimiento de casos vulnerables.',
    'imagenes'=>[ img('donacion_ropa','donation,clothes'), img('comunidad_ayuda','community,help') ],
    'tags'=>['#comunidad','#inclusión'],
  ...
  [
    ...
    'autor'=>'Carlos A. Núñez','rol'=>'Coordinador',
    'avatar'=>'https://i.pravatar.cc/64?img=55',
    'titulo'=>'Recuperación de áreas verdes – Urb. Palermo',
    'codigo'=>'AMB-029-2025',
    'contenido'=>'Se podó, pintó y sembraron 80 plantones. Junta vecinal se comprometió con el mantenimiento.',
  ...
  [
    ...
    'titulo'=>'Taller de reciclaje creativo – I.E. Víctor Raúl',
    'codigo'=>'EDU-021-2025',
    'contenido'=>'Estudiantes elaboraron macetas y útiles con materiales reutilizados. Exposición programada.',
    'imagenes'=>[ img('reciclaje_manualidades','recycling,craft'), img('upcycling_estudiantes','upcycling,students') ],
    'tags'=>['#educación','#ambiente'],
    'facultad_id'=>6,'departamento_id'=>0,'periodo_id'=>1,'oficina'=>'PCF',
  ...
  [
    ...
    'titulo'=>'Huertos familiares – Centro Poblado El Trópico',
    'codigo'=>'AGR-008-2025',
    'contenido'=>'Se instalaron 15 huertos con riego por goteo artesanal y capacitación básica.',
  ...
  [
    ...
    'codigo'=>null,
    'contenido'=>'Recuerden actualizar avances y evidencias (fotos, enlaces) cada 15 días según la guía RSU.',
  ...
  [
    ...
    'titulo'=>'Orquesta infantil – Barrio Chicago',
    'codigo'=>'ART-002-2025',
    'contenido'=>'Se formó el ensamble inicial con 25 niñas y niños. Presentación piloto en 4 semanas.',
...
/* Resumen por oficina (sobre el conjunto filtrado que estás viendo) */
...
/* Imágenes del post: 500px de alto + recorte moderno */
...
/* Tarjetas de la barra lateral con diseño compacto y colores */
...
/* Scroll de feed (ya existente) – lo mantenemos */
...
/* Aside sticky para aprovechar la altura y ver muchos módulos */
.rsu-social .aside{
...
.rsu-social .feed-scroll{
  overflow-y:auto;
  padding-right:6px; /* respiración al borde del scroll */
}
...
<div class="rsu-social">
  ...
  <div class="row g-2 mb-2">
    ...
    <div class="col-12 col-md-3">
      <div class="p-3 kpi-card h-100 d-flex align-items-center justify-content-between">
        <div><div class="num"><?= (int)$kpi_aprob_total_recientes ?></div><div class="lbl">Aprobación Total recientes</div></div>
  ...
  <div class="layout">
    ...
    <div class="left">
      <div class="composer-card p-3 mb-2">
        <div class="composer-title mb-2"><i class="fas fa-pen-to-square text-primary"></i> ¿Qué avance quieres compartir? <span class="small-muted">(Demo, no guarda en BD)</span></div>
        <div class="row g-2">
          ...
          <div class="col-12 col-sm-7">
            <label class="small-muted mb-1">Código proyecto</label>
            <input type="text" id="cmp_codigo" class="form-control form-control-sm" placeholder="ENF-014-2025">
          </div>
          <div class="col-12">
            <label class="small-muted mb-1">Título</label>
            <input type="text" id="cmp_titulo" class="form-control form-control-sm" placeholder="Título del proyecto o anuncio">
          </div>
          <div class="col-12">
            <label class="small-muted mb-1">Contenido</label>
            <textarea id="cmp_cont" class="form-control form-control-sm" rows="3" placeholder="Describe el avance…"></textarea>
          </div>
      ...
      <div class="filters-card p-3 mb-2">
        ...
        <form id="frmFiltros" method="get" class="mb-0">
          ...
          <div class="row g-2">
            ...
            <div class="col-6">
              <label class="small-muted mb-1">Período</label>
            ...
            <div class="col-12">
              ...
              <div class="d-flex">
                <input type="text" name="q" value="<?= htmlspecialchars($q) ?>" class="form-control form-control-sm" placeholder="Proyecto, coordinador, código, texto">
            ...
            <div class="col-12">
              ...
              <select name="orden" class="form-control form-control-sm">
                ...
                <option value="comentados" <?= $orden==='comentados'?'selected':''; ?>>Más comentados</option>
                <option value="aprobados"  <?= $orden==='aprobados'?'selected':''; ?>>Con aprobación total</option>
        ...
        <div class="mt-2">
          ...
          <span class="chip-tag" data-tag="#educación">#educación</span>
              ...
              <header class="feed-hd">
                ...
                <div class="w-100">
                  <div class="d-flex justify-content-between">
                    <h5 class="feed-title"><?= htmlspecialchars($p['autor']) ?> <small class="feed-meta">· <?= htmlspecialchars($p['rol']) ?></small></h5>
              ...
              <?php foreach ($top_authors as $name => $st): ?>
                <li>
                  ...
                  <div>
                    ...
                    <div class="mini-meta"><i class="far fa-file-lines"></i> <?= (int)$st['posts'] ?> posts · <i class="far fa-thumbs-up ml-1"></i> <?= (int)$st['likes'] ?> likes</div>
                  </div>
                </li>
              <?php endforeach; ?>
            </ul>
          <?php else: ?>
            <span class="small-muted">Aún no hay actividad.</span>
          <?php endif; ?>
        </div>
      </div>
        ...
        <div class="aside-bd">
          <ul class="mini-list">
            <li>
              ...
              <div>
                <div class="font-weight-bold" style="line-height:1.15">Cierre presentación de proyectos</div>
                <div class="mini-meta">25/04/2026 · 23:59</div>
              </div>
            </li>
            <li>
              ...
              <div>
                ...
                <div class="mini-meta">Cada 15 días (demo)</div>
              </div>
            </li>
            <li>
              <i class="far fa-handshake fa-lg text-success"></i>
              <div>
                <div class="font-weight-bold" style="line-height:1.15">Taller de buenas prácticas</div>
                <div class="mini-meta">20/05/2026 · 10:00</div>
              </div>
            </li>
          </ul>
        </div>
...
<script>
/* ===== Altura dinámica del contenedor scrolleable del feed =====
   Calcula la altura disponible desde la posición del feed hasta el final del viewport
   para que sólo scrollee el listado y no toda la página. */
(function(){
  function setFeedHeight(){
    ...
    var margenInferior = 16; // respiración
...
(function(){
  ...
  btn.addEventListener('click', function(){
    ...
    if (!titulo || !cont){ alert('Completa al menos Título y Contenido.'); return; }

    const autor = (tipo==='rsu') ? 'Dirección RSU' : 'Coordinador/a';
    ...
    const html = `
      <article class="feed-card">
        <header class="feed-hd">
          ...
          <div class="w-100">
            <div class="d-flex justify-content-between">
              <h5 class="feed-title">${autor} <small class="feed-meta">· ${rol}</small></h5>
