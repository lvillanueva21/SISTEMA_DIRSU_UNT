...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $beneficiados = isset($_POST['beneficiados']) ? $_POST['beneficiados'] : null;
        ...
        $sql_update_proyecto = "UPDATE proyectos_finales
                                SET lugar = ?, beneficiados = ?, fecha_inicio = ?, fecha_fin = ?
                                WHERE id_py = ?";
        ...
        $stmt->bind_param('ssssi', $lugar, $beneficiados, $fecha_inicio, $fecha_fin, $id_proyecto);
