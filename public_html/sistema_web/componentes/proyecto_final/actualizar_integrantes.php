...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt->bind_param('ssssi', $coordinador, $integrantes, $estudiantes, $omi, $id_proyecto);
