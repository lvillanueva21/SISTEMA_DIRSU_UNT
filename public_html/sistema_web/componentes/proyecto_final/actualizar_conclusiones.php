...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $conclusiones = isset($_POST['conclusiones']) ? $_POST['conclusiones'] : null;
        $analisis = isset($_POST['analisis']) ? $_POST['analisis'] : null;
        ...
        $sql_update_proyecto = "UPDATE proyectos_finales
                                SET conclusiones = ?, analisis = ?, recomendaciones = ?
                                WHERE id_py = ?";
        ...
        $stmt->bind_param('sssi', $conclusiones, $analisis, $recomendaciones, $id_proyecto);
