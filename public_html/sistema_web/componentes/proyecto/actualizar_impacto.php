...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $entregables = isset($_POST['entregables']) ? $_POST['entregables'] : null;
        $impacto = isset($_POST['impacto']) ? $_POST['impacto'] : null;
        ...
        $sql_update_proyecto = "UPDATE proyectos 
                                SET entregables = ?, impacto = ?, matriz = ?
                                WHERE id = ?";
        ...
        $stmt->bind_param('sssi', $entregables, $impacto, $matriz, $id_proyecto);
