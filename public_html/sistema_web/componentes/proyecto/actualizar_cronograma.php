...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $cronograma1 = isset($_POST['cronograma1']) ? $_POST['cronograma1'] : null;
        $cronograma2 = isset($_POST['cronograma2']) ? $_POST['cronograma2'] : null;

        // Preparar la consulta para actualizar los datos en la tabla proyectos
        $sql_update_proyecto = "UPDATE proyectos 
                                SET cronograma1 = ?, cronograma2 = ?
                                WHERE id = ?";
        ...
        $stmt->bind_param('ssi', $cronograma1, $cronograma2, $id_proyecto);
