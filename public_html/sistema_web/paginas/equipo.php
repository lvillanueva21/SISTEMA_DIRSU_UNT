...
<head>
  ...
  <!-- Favicon -->
    <link href="../../dist/img/dirsu_ico_128_128.ico" rel="icon">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../../dist/img/dirsu_logo_128_128.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Barra de búsqueda general -- se oculta por el momento -- no parece ser necesario -->
      <!--
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="." class="brand-link">
      <img src="../../dist/img/dirsu_logo_128_128.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="paginas/registro_proyecto.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-7">
            <h1 class="m-0">!Bienvenido al Sistema de gestión de proyectos DIRSU!</h1>
          </div><!-- /.col -->
          <div class="col-sm-5">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href=".">Inicio</a></li>
              <li class="breadcrumb-item active">Página activa</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
