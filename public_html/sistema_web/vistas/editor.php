...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="../plogins/summernote/summernote-bs4.min.css">
        <!-- CodeMirror -->
  <link rel="stylesheet" href="../plogins/codemirror/codemirror.css">
      <!-- Theme style -->
      ...
      <div class="wrapper">
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="formato.php" class="nav-link active">
                     ...
                     <li class="nav-item menu">
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                              <a href="registro_proyecto.php" class="nav-link">
        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
            <!-- Formulario que envía los datos a validarTexto.php -->
...
<!-- CodeMirror -->
<script src="../plogins/codemirror/codemirror.js"></script>
      <!-- Select2 -->
