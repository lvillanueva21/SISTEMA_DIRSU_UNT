            ...
            <div class="sidebar">
               ...
               <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                  ...
                  <?php
                     ...
                     ?>
                  <div class="info">
                     <a href="perfil.php" style="color: white; text-shadow: 0 0 10px rgba(255, 255, 255, 0.8);"><?php echo $texto_a_imprimir; ?></a>
                  </div>
               </div>
               <!-- SidebarSearch Form -->
               <!--
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item menu">
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                              <a href="informe_final.php" class="nav-link">
                                 <!-- <i class="far fa-circle nav-icon"></i> -->
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                             <select class="form-control" id="id_depa" name="id_depa" required>
                                                ...
                                                <option value="52" <?php echo (isset($id_depa) && $id_depa == '52') ? 'selected' : ''; ?>>Ingeniería Mecatrónica</option>
                                             </select>
                                          </div>
                                       </div>
                                       <div class="form-group row">
