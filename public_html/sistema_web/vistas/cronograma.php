...
<html lang="en">
   <head>
      ...
      <title>Cronograma de ejecución del proyecto - Sistema DIRSU</title>
      <!-- Favicon -->
    ...
    <a href="progreso.php" class="nav-link">
        ...
        <p>Mi progreso</p>
                     ...
                     <li class="nav-item menu menu-open">
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                              <a href="cronograma.php" class="nav-link active">
                                 <!-- <i class="far fa-circle nav-icon"></i> -->
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-0">
                     <div class="col-sm-7">
                        <h1 class="m-0">Cronograma de ejecución del proyecto</h1>
                     </div>
                     <!-- /.col -->
