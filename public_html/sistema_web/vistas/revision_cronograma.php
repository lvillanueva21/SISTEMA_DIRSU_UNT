...
<html lang="en">
   <head>
      ...
      <title>Revisión de cronograma de ejecución - Sistema DIRSU</title>
      <!-- Favicon -->
        ...
        <p>Mi progreso</p>
                     ...
                     <li class="nav-item menu menu-open">
                        ...
                        <ul class="nav nav-treeview">
                           ...
                           <li class="nav-item">
                              <a href="revision_cronograma.php" class="nav-link active">
                                 <!-- <i class="far fa-circle nav-icon"></i> -->
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-0">
                     <div class="col-sm-7">
                        <h1 class="m-0">Revisión de cronograma de ejecución</h1>
                     </div>
                     <!-- /.col -->
