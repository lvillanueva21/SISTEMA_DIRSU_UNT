...
<head>
    <meta charset="utf-8">
    <title>DIRSU - Banda de Música</title> <!-- ::::Cambiar nombre de pestaña:::: -->
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">CECUNT - Banda de Música</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item active" aria-current="page">Sumérgete en el vibrante mundo musical donde tradición y talento se fusionan. Conoce a nuestros talentosos miembros, disfruta de nuestras presentaciones y mantente al tanto de nuestros próximos eventos. ¡Únete a nosotros y siente el ritmo de la excelencia universitaria!.</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Conoce nuestros conciertos</h1>
            </div>
            <div class="row wow fadeInUp" data-wow-delay="0.3s">
                <div class="col-12 text-center">
                    <ul class="list-inline rounded mb-5" id="portfolio-flters">
                        <li class="mx-2 active" data-filter="*">Todos</li>
                        <li class="mx-2" data-filter=".first">Próximos conciertos</li>
                        <li class="mx-2" data-filter=".second">últimos conciertos</li>
                    </ul>
                </div>
            </div>
            <div class="row g-4 portfolio-container">
                <div class="col-lg-4 col-md-6 portfolio-item first wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="../../img/bm5.png" alt="">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Martes 24 de julio<br>Auditorio Copérnico</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="../../img/bm2.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.3s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="../../img/bm3.png" alt="">
                        <div class="portfolio-text">
                            <h4 class="text-white mb-4">Pruning plants</h4>
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="../../img/bm4.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-inner rounded">
                        <img class="img-fluid" src="../../img/bm1.png" alt="">
                        <div class="portfolio-text">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item second wow fadeInUp" data-wow-delay="0.5s">
                    <div class="portfolio-inner rounded">
                        ...
                        <div class="portfolio-text">
                            ...
                            <div class="d-flex">
                                <a class="btn btn-lg-square rounded-circle mx-2" href="../../img/bm6.png" data-lightbox="portfolio"><i class="fa fa-eye"></i></a>
                                <a class="btn btn-lg-square rounded-circle mx-2" href=""><i class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
