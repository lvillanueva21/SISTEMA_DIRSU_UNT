...
<head>
    <meta charset="utf-8">
    <title>DIRSU - Grupo de Danza</title> <!-- ::::Cambiar nombre de pestaña:::: -->
...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Grupo de danza</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item active" aria-current="page">Conoce más sobre nuestra Grupo de Danza de la Universidad Nacional de Trujillo.</li>
                </ol>
            </nav>
        </div>
    </div>
